...
function Necrosis_Localization_Speech_Ru()

	NECROSIS_INVOCATION_MESSAGES = {
		[1] = {
			"Для открытия межгалактических путей, нажмите на портал.",
		},
		[2] = {
			"Добро пожаловать на борт Темных Авиалиний.",
			"Напоминаем, что на борту запрещено курение на всем протяжении полета.",
		},
		[3] = {
			"Если Вы нажмете на портал, мы намного быстрее начнем веселиться!",
		},
		[4] = {
			"Если Вы не хотите, чтобы из этого портала вылезла демоническая гадость, нажмите на него скорее!",
		},
	};

	NECROSIS_SOULSTONE_ALERT_MESSAGE = {
		[1] = {
			"Если Вы затаили идею массового суицида, смею Вас расстроить! <target> сейчас может самостоятельно оживить свой труп и всё будет хорошо!",
		},
		[2]= {
			"<target> теперь может отправиться гулят, выпить кофе или принять ванну. Сохраненная душенка может позволить ему разок сдохнуть...",
		},
	};
	...
	NECROSIS_SHORT_MESSAGES = {
		{{"--> <target> камень души через 30 мин. <--"}},
		{{"<TP> Призыв <target>, пожалуйста, кликните по порталу <TP>"}},
	};
